...
export default function App() {
  ...
  <div style={{ backgroundColor: "#fff", padding: "1rem", marginTop: "1rem", border: "1px solid #ccc", borderRadius: "8px" }}>
    ...
    <p>
      <strong>Равномерное распределение</strong> – характерно для дискретных случайных величин, где все исходы равновероятны (например, бросок идеальной игральной кости). Функцию ρ(t) называют плотностью вероятности или законом распределения исследуемой величины:
    </p>

    <p>
      где N — общее число бросков,<br />
      ΔN — число попаданий в интервал Δt.
    </p>

    <img src="/Фото 1.png" alt="Формула равномерного распределения" style={{maxWidth: "100%", margin: "1rem 0"}} />

    <p>
      <strong>Нормальное распределение</strong> — это одно из фундаментальных распределений в статистике. Оно описывает, как значения случайной величины располагаются вокруг её среднего. Визуально оно представлено в виде симметричной колоколообразной кривой, называемой <strong>кривой Гаусса</strong>.
    </p>
    ...
    <img src="/Фото 2.png" alt="Формула нормального распределения" style={{maxWidth: "100%", margin: "1rem 0"}} />

    <p>
      где:<br />
      ⟨t⟩ — математическое ожидание (среднее значение),<br />
      σ — стандартное отклонение (мера разброса данных),<br />
      t — значение измеряемой величины,<br />
      σ² — дисперсия, для костей:<br />
      ⟨t⟩ = 3.5 ⋅ N — среднее для суммы костей,<br />
      σ² = N ⋅ 35/12 — дисперсия.
    </p>

    <p>
      <strong>Почему используются кубики?</strong><br />
    ...
    <ul>
      <li>Один кубик (равномерное распределение от 1 до 6)</li>
      <li>Несколько кубиков (сумма независимых величин)</li>
      <li>Много бросков (гистограмма приближается к нормальному распределению)</li>
    </ul>

    <p>
      <strong>На графике:</strong>
    </p>
